...
#define KAZE_NS_INTERNAL KAZE_NS::i_
...
#else
#define KAZE_NAMESPACE_BEGIN namespace KAZE_NS_INTERNAL {
#define KAZE_NAMESPACE_END }
...
#define KAZE_PUBLIC_NS_BEGIN namespace KAZE_NS {
#define KAZE_PUBLIC_NS_END }
