...
#include <kaze/internal/core/input/CursorMgr.h>
#include <kaze/internal/core/platform/backend/backend.h>
#include <kaze/internal/core/platform/BackendInitGuard.h>
#include <kaze/internal/core/platform/defines.h>
#include <kaze/internal/graphics/Renderer.h>

#include <kaze/internal/tk/FramerateCounter.h>
...
auto App::graphics() const noexcept -> const Renderer &
{
    return m->graphics;
}

auto App::graphics() noexcept -> Renderer &
{
    return m->graphics;
}
