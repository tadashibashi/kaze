#pragma once
#ifndef kaze_input_inputevents_h_
#define kaze_input_inputevents_h_
...
struct FileDropEvent
{
    ...
    void *window;    /// window file got dropped on
...
struct KeyboardEvent
{
    ...
    void *window;   ///< window associated with the event
};
