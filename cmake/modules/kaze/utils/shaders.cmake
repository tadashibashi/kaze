function(_kaze_bgfx_get_profile_ext PROFILE PROFILE_EXT)
    ...
    string(REPLACE spirv spirv PROFILE ${PROFILE})
    string(REPLACE metal metal PROFILE ${PROFILE})
...
function(kaze_compile_shaders)
    ...
    foreach(SHADER_FILE ${IN_SHADERS})
        ...
        _kaze_compile_shaders_impl(
            SHADERC "${CMAKE_SOURCE_DIR}/build/util/bin/shaderc" # if this wasn't built by util/setup it will attempt to build it with this configuration
            TYPE "${SHADER_TYPE}"
